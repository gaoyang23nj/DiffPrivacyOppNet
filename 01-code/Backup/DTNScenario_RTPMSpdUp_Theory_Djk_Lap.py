...
from Backup.RoutingRTPMSpdUp_Theory_Djk_Lap import RoutingRTPMSpdUp_Theory_Djk_Lap
...
class DTNScenario_RTPMSpdUp_Theory_Djk_Lap(object):
    # node_id的list routingname的list
    def __init__(self, scenarioname, num_of_nodes, buffer_size, min_time, max_ttl, lap_noise_scale):
        print('memo')
        ...
        for node_id in range(num_of_nodes):
            tmpRouter = RoutingRTPMSpdUp_Theory_Djk_Lap(node_id, num_of_nodes, min_time, self.list_weather, self.max_ttl, lap_noise_scale)
