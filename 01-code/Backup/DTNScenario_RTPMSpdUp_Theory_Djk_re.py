...
from Backup.RoutingRTPMSpdUp_Theory_Djk_re2 import RoutingRTPMSpdUp_Theory_Djk_re2
...
class DTNScenario_RTPMSpdUp_Theory_Djk_re(object):
    ...
    def __init__(self, scenarioname, num_of_nodes, buffer_size, min_time, max_ttl):
        ...
        for node_id in range(num_of_nodes):
            tmpRouter = RoutingRTPMSpdUp_Theory_Djk_re2(node_id, num_of_nodes, min_time, self.list_weather, self.max_ttl)
