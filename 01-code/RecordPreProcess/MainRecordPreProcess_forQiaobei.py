...
EncoHistBadDir = '../EncoHistData_NJBike/data_bad_qiaobei.csv'
StationInfoPath = '../EncoHistData_NJBike/station_info_qiaobei.csv'
EncoHistDir_SDPair = '../EncoHistData_NJBike/SDPair_NJBike_Data_qiaobei'
