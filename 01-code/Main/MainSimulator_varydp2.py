...
class Simulator(object):
    ...
    def init_scenario_Lap_Pintra(self):
        index = -1
    ...
    def init_scenario_Lap_Pinter(self):
        index = -1
    ...
    def init_scenario_DODP_Pintra(self):
        index = -1
        ...
        # ===============================场景1 RTPM_Theory_Djk_re_Lap ===================================
        index += 1
        tmp_senario_name = 'scenario' + str(index) + 'DTNScenario_RTPMSpdUp_Theory_Djk_OpDP_Pp'
        eps_p = 0.4
        lap_noise_scale = [2. / eps_p, 1]
        tmpscenario = DTNScenario_RTPMSpdUp_Theory_Djk_OpDP_Pp(tmp_senario_name, self.MAX_NODE_NUM, 20000,
                                                                self.MIN_RUNNING_TIMES, self.MAX_RUNNING_TIMES,
    ...
    def init_scenario_DODP_Pinter(self):
        index = -1
...
if __name__ == "__main__":
    for kkk in range(1):
        ...
        # result file path
        short_time = datetime.datetime.now().strftime('%Y%m%d%H%M%S')
        result_file_path = "res_dpoppnet_eps_" + short_time + ".csv"
