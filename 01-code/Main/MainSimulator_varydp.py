...
from Main.Scenario.DTNScenario_RTPMSpdUp_Theory_Djk_re_Lap import DTNScenario_RTPMSpdUp_Theory_Djk_re_Lap
...
class Simulator(object):
    ...
    def init_scenario(self):
        self.scenaDict = {}
        list_scena = self.init_scenario_Lap()
        return list_scena

    def init_scenario_Lap(self):
        index = -1

        # ===============================场景1 RTPM_Theory_Djk_re_Lap ===================================
        index += 1
        tmp_senario_name = 'scenario' + str(index) + 'DTNScenario_RTPMSpdUp_Theory_Djk_re_Lap_01'
        lap_noise_scale = [0.1, 0.]
        tmpscenario = DTNScenario_RTPMSpdUp_Theory_Djk_re_Lap(tmp_senario_name, self.MAX_NODE_NUM, 20000,
        ...
        # ===============================场景1 RTPM_Theory_Djk_re_Lap ===================================
        # index += 1
        # tmp_senario_name = 'scenario' + str(index) + 'DTNScenario_RTPMSpdUp_Theory_Djk_re_Lap_02'
        # lap_noise_scale = 0.2
        # tmpscenario = DTNScenario_RTPMSpdUp_Theory_Djk_re_Lap(tmp_senario_name, self.MAX_NODE_NUM, 20000,
        #                                                       self.MIN_RUNNING_TIMES, self.max_ttl, lap_noise_scale)
        # self.scenaDict.update({tmp_senario_name: tmpscenario})

        # ===============================场景2 RTPM_Theory_Djk_re_Lap ===================================
        index += 1
        tmp_senario_name = 'scenario' + str(index) + 'DTNScenario_RTPMSpdUp_Theory_Djk_re_Lap_03'
        ...
        # ===============================场景3 RTPM_Theory_Djk_re_Lap ===================================
        index += 1
        tmp_senario_name = 'scenario' + str(index) + 'DTNScenario_RTPMSpdUp_Theory_Djk_re_Lap_04'
        lap_noise_scale = [0.1, 0.5]
        tmpscenario = DTNScenario_RTPMSpdUp_Theory_Djk_re_Lap(tmp_senario_name, self.MAX_NODE_NUM, 20000,
                                                              self.MIN_RUNNING_TIMES, self.MAX_RUNNING_TIMES,
                                                              self.max_ttl, lap_noise_scale)
        self.scenaDict.update({tmp_senario_name: tmpscenario})
        ...
        # ===============================场景3 RTPM_Theory_Djk_re_Lap ===================================
        index += 1
        tmp_senario_name = 'scenario' + str(index) + 'DTNScenario_RTPMSpdUp_Theory_Djk_re_Lap_05'
        lap_noise_scale = [0.1, 1]
        tmpscenario = DTNScenario_RTPMSpdUp_Theory_Djk_re_Lap(tmp_senario_name, self.MAX_NODE_NUM, 20000,
                                                              self.MIN_RUNNING_TIMES, self.MAX_RUNNING_TIMES,
                                                              self.max_ttl, lap_noise_scale)
        self.scenaDict.update({tmp_senario_name: tmpscenario})
