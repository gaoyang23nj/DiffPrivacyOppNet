...
from Main.Routing.RoutingRTPMSpdUp_Theory_Djk_re2_Lap import RoutingRTPMSpdUp_Theory_Djk_re2_Lap
...
class DTNScenario_RTPMSpdUp_Theory_Djk_re_Lap(object):
    ...
    def __init__(self, scenarioname, num_of_nodes, buffer_size, min_time, max_time, max_ttl, lap_noise_scale):
        ...
        for node_id in range(num_of_nodes):
            tmpRouter = RoutingRTPMSpdUp_Theory_Djk_re2_Lap(node_id, num_of_nodes, min_time, max_time,
