...
from Main.Routing.RoutingRTPMSpdUp import RoutingRTPMSpdUp
...
class DTNScenario_RTPMSpdUp(object):
    ...
    def __init__(self, scenarioname, num_of_nodes, buffer_size, min_time, max_ttl):
        ...
        for node_id in range(num_of_nodes):
            tmpRouter = RoutingRTPMSpdUp(node_id, num_of_nodes, min_time, self.list_weather, self.max_ttl)
