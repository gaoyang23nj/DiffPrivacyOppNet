...
from Main.Routing.RoutingRTPM import RoutingRTPM
...
class DTNScenario_RTPM(object):
    ...
    def __init__(self, scenarioname, num_of_nodes, buffer_size, min_time, max_ttl):
        ...
        for node_id in range(num_of_nodes):
            tmpRouter = RoutingRTPM(node_id, num_of_nodes, min_time, self.list_weather, self.max_ttl)
