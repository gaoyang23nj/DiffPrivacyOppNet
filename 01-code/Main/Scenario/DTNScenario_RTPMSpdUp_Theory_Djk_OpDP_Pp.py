...
from Main.Routing.RoutingRTPMSpdUp_Theory_Djk_OpDP_Pp import RoutingRTPMSpdUp_Theory_Djk_OpDP_Pp
...
class DTNScenario_RTPMSpdUp_Theory_Djk_OpDP_Pp(object):
    ...
    def __init__(self, scenarioname, num_of_nodes, buffer_size, min_time, max_time, max_ttl, lap_noise_scale):
        ...
        for node_id in range(num_of_nodes):
            tmpRouter = RoutingRTPMSpdUp_Theory_Djk_OpDP_Pp(node_id, num_of_nodes, min_time, max_time,
