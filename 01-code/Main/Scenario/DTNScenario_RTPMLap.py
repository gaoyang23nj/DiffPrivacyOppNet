...
from Main.Routing.RoutingRTPMLap import RoutingRTPMLap
...
class DTNScenario_RTPMLap(object):
    ...
    def __init__(self, scenarioname, num_of_nodes, buffer_size, min_time, max_ttl, lap_noise_scale):
        ...
        for node_id in range(num_of_nodes):
            tmpRouter = RoutingRTPMLap(node_id, num_of_nodes, min_time, self.list_weather, self.max_ttl, lap_noise_scale)
