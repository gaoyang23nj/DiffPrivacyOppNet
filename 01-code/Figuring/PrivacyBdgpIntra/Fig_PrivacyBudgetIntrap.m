...
Input = ["res_oppnet_varyeps_pintra_qiaobeidata_20230420140827.csv"];

%% get parameters
num = size(Input);
num = num(2);
%%tmp para 为了获得参数 先执行一�?
%Input(1,i)
...
for j=1:num
    ...
    % 各列属�?? succ_ratio,avg_delay,num_comm,num_gen,num_succ,gen_freq,privacy parameter
