...
Input = ["res_oppnet_varyeps_pintra_qiaobeidata_20230124092927.csv",
    "res_oppnet_varyeps_pintra_qiaobeidata_20230125082935.csv",
    "res_oppnet_varyeps_pintra_qiaobeidata_20230126091915.csv",
    "res_oppnet_varyeps_pintra_qiaobeidata_20230128163413.csv"];
...
for j=1:num
    ...
    para_privacyIntra = zeros(1,num_privacys);
...
%        delivery_load(:,i) = all_res((i-1)*4+1:i*4,3)./all_res((i-1)*4+1:i*4,5);
        ...
        para_privacyIntra(1,i) = all_res((i-1)*num_routings+1,7);
    end
...
figure(1)
hold on;
h1 = plot(para_privacyIntra,delivery_ratio(1,:),'color',c(1,:),'linestyle','-','marker','^','LineWidth',2, 'MarkerSize',8);
h2 = plot(para_privacyIntra,delivery_ratio(2,:),'color',c(2,:),'linestyle','--','marker','o','LineWidth',2, 'MarkerSize',8)
h3 = plot(para_privacyIntra,delivery_ratio(3,:),'color',c(3,:),'linestyle','-','marker','*','LineWidth',2, 'MarkerSize',8)
h4 = plot(para_privacyIntra,delivery_ratio(4,:),'color',c(4,:),'linestyle','--','marker','+','LineWidth',2, 'MarkerSize',8)
% h5 = plot(para_rate,delivery_ratio(5,:),'color',c(5,:),'linestyle','-','marker','v','LineWidth',2, 'MarkerSize',8)
set(gca, 'Fontname', 'Times New Roman','FontSize',16);
xlim([min(para_privacyIntra) max(para_privacyIntra)]);
...
figure(2)
hold on;
h1 = plot(para_privacyIntra,delivery_latency(1,:),'color',c(1,:),'linestyle','-','marker','^','LineWidth',2, 'MarkerSize',8);
h2 = plot(para_privacyIntra,delivery_latency(2,:),'color',c(2,:),'linestyle','--','marker','o','LineWidth',2, 'MarkerSize',8)
h3 = plot(para_privacyIntra,delivery_latency(3,:),'color',c(3,:),'linestyle','-','marker','*','LineWidth',2, 'MarkerSize',8)
h4 = plot(para_privacyIntra,delivery_latency(4,:),'color',c(4,:),'linestyle','--','marker','+','LineWidth',2, 'MarkerSize',8)
...
figure(3)
hold on;
h1 = plot(para_privacyIntra,delivery_load(1,:),'color',c(1,:),'linestyle','-','marker','^','LineWidth',2, 'MarkerSize',8);
h2 = plot(para_privacyIntra,delivery_load(2,:),'color',c(2,:),'linestyle','--','marker','o','LineWidth',2, 'MarkerSize',8)
h3 = plot(para_privacyIntra,delivery_load(3,:),'color',c(3,:),'linestyle','-','marker','*','LineWidth',2, 'MarkerSize',8)
h4 = plot(para_privacyIntra,delivery_load(4,:),'color',c(4,:),'linestyle','--','marker','+','LineWidth',2, 'MarkerSize',8)
