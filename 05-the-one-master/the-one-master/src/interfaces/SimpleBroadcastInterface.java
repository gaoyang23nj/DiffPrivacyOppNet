...
public class SimpleBroadcastInterface extends NetworkInterface {
	...
	public void connect(NetworkInterface anotherInterface) {
		if (isScanning()
			...
			System.out.println("Error! we do not need this function! SimpleBroadcastInterface connect()");
	...
	public void createConnection(NetworkInterface anotherInterface) {
		if (!isConnected(anotherInterface) && (this != anotherInterface)) {
			...
			System.out.println("Error! we do not need this function! SimpleBroadcastInterface createConnection()");
	...
	@Override
	public void createOneWayConnection(NetworkInterface anotherInterface) {
		if (!isConnected(anotherInterface) && (this != anotherInterface)) {
			// connection speed is the lower one of the two speeds
			int conSpeed = anotherInterface.getTransmitSpeed(this);
			if (conSpeed > this.transmitSpeed) {
...
//			System.out.println("createOneWayConnection() from %s to %s".format(this.toString(), 
//					anotherInterface.getHost().toString()));
			
			Connection con = new CBRConnection(this.host, this,
					anotherInterface.getHost(), anotherInterface, conSpeed);
			oneway_connect(con,anotherInterface);
		}
