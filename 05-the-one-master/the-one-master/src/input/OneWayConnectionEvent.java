 ...
 */
public class OneWayConnectionEvent extends ExternalEvent {
	 ...
	 */
	public OneWayConnectionEvent(int from, int to, String interf, boolean up, double time) {
		super(time);
	...
	public void processEvent(World world) {
		...
		//construct one-way connection		
		from.forceOneWayConnection(to, interfaceId, this.isUp);
//		if (this.isUp == true) {
